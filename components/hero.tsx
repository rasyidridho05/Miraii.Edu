...
const Hero = () => {
  return (
    <section id="">
      <div className="relative w-screen pt-16 md:pt-0">
        <Image
          ...
          priority
        />
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white z-6 flex flex-col gap-4 w-2/5 pt-16 md:pt-0">
