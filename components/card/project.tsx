...
const Project = ({ thumbnail, title, desc, link }: GameType) => {
  return (
    <div className="col-span-12 sm:col-span-6 md:col-span-4 bg-none rounded-xl p-4 group bg-[#BCDDFF] bg-opacity-50 border-4 border-white hover:bg-[#1741B6] hover:bg-opacity-50 transition-all duration-300">
      <div className="">
        <Link href={`${link}`}>
      ...
      <div className=" p-4 flex flex-col justify-between rounded-b-lg ">
        <div className="pb-4">
          <h1 className="text-xl font-medium mb-1 text-white">{title}</h1>
          <p className="text-[#FAFAFA] text-base">{desc}</p>
        </div>
